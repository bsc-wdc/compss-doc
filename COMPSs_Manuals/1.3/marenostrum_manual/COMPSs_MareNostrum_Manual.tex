...
\begin{document}
  ...
  \begin{titlepage} 
    \begin{center} 
      ...
      \HRule \\[0.4cm] 
      { \huge \bfseries COMPSs at MareNostrum Manual \\[0.4cm] }
      \HRule \\[1.5cm] 
  ...
  %%%%%%%% REFERENCE NOTES %%%%%%%%%%
  {
    ...
    how to load them and how to create and track a COMPSs job. 
    \newline
    
    If you want to install COMPSs at your local machine please refer to the \textit{COMPSs Installation Manual} available at our
