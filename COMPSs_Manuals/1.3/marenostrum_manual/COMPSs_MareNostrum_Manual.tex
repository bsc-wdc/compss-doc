...
\begin{document}
  ...
  %%%%%%%% REFERENCE NOTES %%%%%%%%%%
  {
    This manual only provides information abou how to install and configure COMPSs. Specifically, it details the installation 
  ...
  \input{./Sections/2_Debian/Debian.tex}
          
  \input{./Sections/3_RedHat_zypper/RedHat_zypper.tex}
  
  \input{./Sections/4_RedHat_yum/RedHat_yum.tex}
           
  \input{./Sections/5_Additional_Configuration/Additional_Configuration.tex}
