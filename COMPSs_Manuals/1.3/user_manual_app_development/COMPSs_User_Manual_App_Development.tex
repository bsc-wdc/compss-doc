...
\begin{document}
  ...
  %%%%%%%% REFERENCE NOTES %%%%%%%%%%
  {
    ...
    A list of COMPSs application examples (codes, execution commands, results, logs, etc.) is available in the \textit{Application Repository section at \url{http://compss.bsc.es/} }.
    \newline
  ...
  \input{./Sections/5_Known_Limitations/Known_Limitations.tex}
