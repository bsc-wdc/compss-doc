...
\begin{document}
  ...
  %%%%%%%% REFERENCE NOTES %%%%%%%%%%
  {
    ...
    An extensive list of COMPSs application examples (codes, execution commands, results, logs, etc.) please refer to the \textit{COMPSs Sample 
    Applications} section at \url{http://compss.bsc.es/} .
  }
