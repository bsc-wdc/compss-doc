...
\begin{document}
  ...
  %%%%%%%% REFERENCE NOTES %%%%%%%%%%
  {
    This manual only provides information about how to execute COMPSs aplications. Specifically, it details
    the options, results and logs of an execution and it provides an overview of the COMPSs tools usage. It is highly recommended
    to follow this manual with a working COMPSs installation. For this purpose we provide a \textit{COMPSs Virtual Machine} 
  ...
  \input{./Sections/5_Common_Issues/Common_Issues.tex}
