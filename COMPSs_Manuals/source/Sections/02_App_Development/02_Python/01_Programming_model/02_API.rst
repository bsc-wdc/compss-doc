...
compss_barrier_group(group_name)
   ...
   *group_name*, but does not return any object.
   ...
   See :ref:`Sections/02_App_Development/02_Python/01_Programming_model/02_API:Task Groups`
...
compss_barrier_group(group_name)
    ...
    applications (see :ref:`Sections/02_App_Development/02_Python/01_Programming_model/01_Decorators/18_Failures_and_exceptions:@on_failure`
