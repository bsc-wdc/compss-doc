...
As supercomputer nodes are connection restricted, the best way to
enable the *COMPSs Monitor* is from the users local machine.
To do so, please install the following packages in your local machine:
...
.. figure:: ./Figures/sc_monitor1.jpeg
   :name: mn_monitor1
...
.. figure:: ./Figures/sc_monitor2.jpeg
   :name: mn_monitor2
