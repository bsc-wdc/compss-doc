|:zap:| Energy Measurement with EAR
***********************************
...
(:ref:`Sections/05_Sample_Applications/02_Python/03_KMeans:KMeans`) in MareNostrum V.

The first step is to connect to MareNostrum V and create a ``kmeans.py`` file containing the
the KMeans application shown in :ref:`Sections/05_Sample_Applications/02_Python/03_KMeans:KMeans`
example.
