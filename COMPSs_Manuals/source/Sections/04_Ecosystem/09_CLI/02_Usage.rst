...
.. tab-set::
   ...
   .. tab-item:: Local
        ...
        .. TIP::
            ...
            with the ``grep`` command (e.g. ``pycopmss inspect *.zip | grep -e CRATE -e "Execution Time"``)
        ...
        **Verbose mode:**
        ...
        master of the computation) together with the total of tasks the node executed. Then, inside each node, statistics per method are provided (again
        ...
        **Compatibility with other WMSs:**
        ...
        Some examples are: CWL, nextflow, Galaxy, Streamflow, Snakemake, Autosubmit, WfExS, and more.
