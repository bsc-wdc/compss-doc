.. _post_install_for_supercomputer:
...
infrastructure (LSF, PBS, SLURM, etc.) please check the :ref:`Sections/01_Installation_Configuration/03_Configuration/02_Supercomputer:Configuration`
Section or contact the COMPSs team at support-compss@bsc.es to find out a solution.
