...
.. TIP::
    ...
    .. WARNING::
        ...
        **Tracing, Kafka, Jacoco and DLB components can NOT be installed in macOS** distributions.
        Therefore, at least options ``-T -K -J -D`` must be used when invoking ``buildlocal``
...
.. _install_from_sources_post_installation:
