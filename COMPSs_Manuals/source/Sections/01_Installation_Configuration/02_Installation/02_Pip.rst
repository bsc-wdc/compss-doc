...
.. _install_using_pip_prerequisites:
...
in the :ref:`Sections/01_Installation_Configuration/01_Dependencies:Dependencies` Section must be satisfied (*do not forget*
...
.. _install_using_pip_installation:
...
.. tab-set::
    ...
    .. tab-item:: Install in user local folder
    ...
    .. tab-item:: Within a virtual environment
...
.. _install_using_post_installation:
