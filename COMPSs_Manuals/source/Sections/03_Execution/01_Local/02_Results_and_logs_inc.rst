...
.. figure:: ./01_Local/Figures/simple_java_stdout.jpeg
...
.. figure:: ./01_Local/Figures/hello_seq_stdout.jpeg
   :name: hello_seq
...
.. figure:: ./01_Local/Figures/hello_compss_stdout_and_job.jpeg
   :name: hello_compss
...
.. figure:: ./01_Local/Figures/simple_log_off.png
   :name: simple_log_off
...
.. figure:: ./01_Local/Figures/simple_log_info.png
...
:ref:`Sections/04_Ecosystem/02_Monitor:|:desktop:| Monitor`.
...
.. figure:: ./01_Local/Figures/simple_runtimelog.jpeg
...
.. figure:: ./01_Local/Figures/simple_resourceslog.jpeg
...
As an example, :numref:`simple_log_api` shows the logs generated by the same
execution than the previous case but with **api** mode.

.. figure:: ./01_Local/Figures/simple_log_api.png
   :name: simple_log_api
   :alt: Structure of the logs folder for the Simple java application in **api** mode
   :align: center
   :width: 25.0%
...
.. figure:: ./01_Local/Figures/simple_log_debug.png
...
in :ref:`Sections/04_Ecosystem:|:tools:| Ecosystem`.

Finally, running COMPSs with **log level trace** extends the debug information
with much more detailed information for debugging specific issues. This log
level generates larger files that the debug log level.
Consequently, users must take care of their quota.
As an example, :numref:`simple_log_trace` shows the logs generated by the same
execution than the previous case but with **trace** mode.

.. figure:: ./01_Local/Figures/simple_log_trace.png
   :name: simple_log_trace
   :alt: Structure of the logs folder for the Simple java application in **trace** mode
   :align: center
   :width: 32.0%
