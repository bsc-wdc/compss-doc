...
With regard to the objects used as parameters and return of the tasks, they must be serializable.
In order to check if an object is serializable, the Python built-in cPickle library can be used:

\begin{lstlisting}[language=python]
from cPickle import loads, dumps

# Instance one object that you want to check if serializable
o = MyObject()

d = dumps(o)
l = loads(d)

# The object o has been serialized into d and deserialized into l.
\end{lstlisting}

A list of the common use serializable objects can be found in:
\begin{lstlisting}[language=html]
https://docs.python.org/2/library/pickle.html#what-can-be-pickled-and-unpickled
\end{lstlisting}
However, PyCOMPSs serialization has been extended to provide support for lambdas, generators and module objects.
