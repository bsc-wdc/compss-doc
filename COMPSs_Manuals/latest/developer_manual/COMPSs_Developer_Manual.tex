...
\begin{document}
  ...
  \begin{titlepage} 
    \begin{center} 
      ...
      \HRule \\[0.4cm] 
      { \huge \bfseries Developer Manual \\[0.4cm] }
      \HRule \\[1.5cm] 
  ...
  %%%%%%%% REFERENCE NOTES %%%%%%%%%%
  {
    This manual only provides development information about COMPSs such as its internal structure, how to implement new connectors,
    how to add new adaptors and how to develop a new scheduler. 
    \newline
