...
This mode is aimed to COMPSs' apps users and developers. Instruments computing threads and some management resources providing information about tasks' executions, 
