...
\begin{document}
  ...
  \vspace*{\fill} 
  \begin{center}
    \large { Please find more details about the COMPSs framework at }
    \huge{\url{https://www.bsc.es/computer-sciences/grid-computing/comp-superscalar}}
  \end{center}    
  \vspace*{\fill} 
