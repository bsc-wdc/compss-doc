...
This decorator enables the user to set the particular constraints for each task, such as the amount of Cores required. A full 
description of the supported constraints can be found in Table \ref{tab:constraints} in Section \ref{sec:Constraints}.
...
%*{\bf @constraint }*)(ComputingUnits="4", AppSoftware="numpy,scipy,gnuplot")
%*{\bf @task }*)(c = INOUT)
def func(a, b, c):
     c += a*b
     ...
